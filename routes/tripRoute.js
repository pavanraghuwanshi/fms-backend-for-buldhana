...
const { createTrip, getAllTrips, updateTrip, deleteTrip, getTripByVehicleId, getTripByDriverId, getTripAnalyticsByTripId, tripCheckIn, getDutySlipByTripId } = require("../controller/tripController");
