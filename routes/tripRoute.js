...
const { createTrip, getAllTrips, updateTrip, deleteTrip, getTripByVehicleId, getTripByDriverId, getTripAnalyticsByTripId, tripCheckIn, getDutySlipByTripId, getAllTripswithPegination} = require("../controller/tripController");
